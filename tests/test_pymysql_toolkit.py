...
class AccessLogDaoBaseTest(unittest.TestCase):
    """
    对AccessLogDao的基本测试，access_log_id的UUID等先手动编了几个
    测试用例简述：
    1. 单条插入
    2. 多条插入（开启事务）
    4. 单条查询
    ...
    def single_insert_and_single_select(self):
        # 手动新建一个AccessLog对象
        ...
        self.assertEqual(access_log.access_date_time, new_access_log.access_date_time)
